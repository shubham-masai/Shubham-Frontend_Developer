    ...
    return (
        <div className="fixed flex justify-between items-center h-[117px] w-full p-[27px] p-[5%] top-[27px] bg-transparent z-50">
            ...
            <div className="flex items-center gap-4">
                ...
                <img
                    src={menu}
                    className="w-10 h-10 cursor-pointer block md:hidden"
                    alt="menu"
                />
                <img
                    src={LogoSaviour}
                    className="object-cover w-[100px] h-[111px] mt-8"
                    alt="Logo Saviour"
                />
                <p className="hidden md:block text-white font-zcool text-[1.2rem]">Saviour</p>
            </div>
            ...
            <div className="hidden md:flex max-w-[583px] h-[52px] bg-[#181918] flex items-center gap-[24px] justify-center p-[16px] p-[24px] text-white rounded-[20px]">
                ...
                <span>
                    <img src={dropdown} alt="dropdown" className="w-[16px] h-[16px] " />
                </span>
            </div>
